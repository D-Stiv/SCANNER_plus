...
class gwnet(nn.Module):
    def __init__(self, device, args, num_nodes, adjinit, in_dim, supports, output_horizon, nhid, dropout, gcn_bool, snorm_bool, tnorm_bool, adaptadj, kernel_size=2, blocks=4, layers=2):
